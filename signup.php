...
<div class="container">
      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input id="username" name="username" placeholder="username (at least 4 characters)" required="" tabindex="2" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['username']; } ?>"> 
